...
const tours = JSON.parse(
  // Read the tours.json file and parse its contents as a JavaScript object.
...
const importData = async () => {
  ...
  try {
    ...
    await User.create(users, { validateBeforeSave: false }); // don't forget to comment the password encryption in user model just for this operation then uncomment it again when done
